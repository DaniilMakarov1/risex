...
- The project is paused at a Product Owner roadmap authorization gate after RX-031 metadata-only follow-up; no new product stage is authorized by source of truth.
